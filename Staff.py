...
class StaffWindow:
    def __init__(self):
        ...
        self.master.geometry("1200x500+30+15")
        self.master.resizable(False,False)
        #########################################################
        self.frameleft = Frame(self.master, width=400,background="#ffa07a")
        ...
        self.firstName = Label(self.frameleft, text='Firstname:', fg='black', font=('tahoma', 12, 'bold'),bg="#ffa07a")
        self.firstName.place(x=10, y=20, width=100, height=40)
        self.lastName = Label(self.frameleft, text='Lastname:', fg='black', font=('tahoma', 12, 'bold'),bg="#ffa07a")
        self.lastName.place(x=10, y=70, width=100, height=40)
        self.Email = Label(self.frameleft, text='Email:', fg='black', font=('tahoma', 12, 'bold'),bg="#ffa07a")
        self.Email.place(x=10, y=120, width=100, height=40)
        self.Phone = Label(self.frameleft, text='Phone:', fg='black', font=('tahoma', 12, 'bold'),bg="#ffa07a")
        self.Phone.place(x=10, y=170, width=100, height=40)
        self.Job = Label(self.frameleft, text='Job:', fg='black', font=('tahoma', 12, 'bold'),bg="#ffa07a")
        ...
        self.buttonAdd = Button(self.frameleft, text="ADD", command=self.add, font=('tahoma', 10, 'bold'), bg = '#FF6633')
        self.buttonAdd.place(x=20, y=380, width=60, height=60)
        self.buttonUpdate = Button(self.frameleft, command=self.update, text="UPDATE", font=('tahoma', 10, 'bold'), bg = '#FF6633')
        self.buttonUpdate.place(x=100, y=380, width=60, height=60)
        self.buttonDelete = Button(self.frameleft, command=self.delete, text="DELETE", font=('tahoma', 10, 'bold'), bg = '#FF6633')
        self.buttonDelete.place(x=180, y=380, width=60, height=60)
        self.buttonRead = Button(self.frameleft, command=self.load_data, text="SHOW", font=('tahoma', 10, 'bold'), bg = '#FF6633')
        self.buttonRead.place(x=260, y=380, width=60, height=60)
        self.buttonReset = Button(self.frameleft, command=self.reset, text="RESET", font=('tahoma', 10, 'bold'), bg = '#FF6633')
        self.buttonReset.place(x=340, y=380, width=60, height=60)

        ############################# right frame start here ######################"""
        self.frameright = Frame(self.master, width=800,bg="#ffa07a")
        self.frameright.pack(side=LEFT, fill=Y)
        ############################# right frame end here ######################"""

        self.framerighttop = Frame(self.frameright, height=50, pady=5, padx=5,bg="#ffa07a")
        ...
        self.buttonsearch = Button(self.framerighttop, command=self.search, text='Search'
                                ,fg='black',font=('tahoma', 12, 'bold'), width=50, bg = '#FF6633')
        ...
        self.frameView.pack(fill=X, padx= 50)
...
#######################################   Bottom Frame       #####################################
        ...
        self.img_stf = Image.open('Image/staff_screen.png')
        self.img_stf.thumbnail((330,330))
        self.new_img_stf = ImageTk.PhotoImage(self.img_stf)


        self.frameBot=Frame(self.frameright,bg='blue',width=50,height=50)
        self.frameBot.pack(pady=10)

        self.std_label = Label(self.frameBot,image=self.new_img_stf,bg="#ffa07a")
        self.std_label.pack()
